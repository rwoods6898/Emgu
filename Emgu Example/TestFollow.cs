...
{
    public partial class TestFollow : Form
    {
        ...
        private void DisplayWebcam()
        {
            ...
            yellowInput.Invoke(new Action(() => yellowInput.Text = yellowThreshold.ToString()));
            ...
            while (_capture.IsOpened)
            {
                ...
                if (yellowLocation[1] > TurnAround) //Turn around if there is enough red pixels
                 {
                    Turnaround();
                    stopWatch.Start();
        ...
        private void LaneFollow(bool Invert_Direction)//Lane Follow Logic
        {
            if (Invert_Direction == false)
            {
        ...
        private void CountLeft_TextChanged_1(object sender, EventArgs e)
        {
       
        }

        private void TestFollow_FormClosed_1(object sender, FormClosedEventArgs e)
        {
        ...
        private void SideBar_Scroll(object sender, EventArgs e)
        {
